...
public class MessageConfiguration {
    private String exchangeName = "products_exchange";
    private String registerQueue = "product_queue";
    ...
    {
        return BindingBuilder.bind(registerQueue()).to(exchange).with("product_routing");
    }
